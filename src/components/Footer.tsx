            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center justify-center h-11 w-11 rounded-xl bg-[#FF0000] hover:bg-[#CC0000] transition-all hover:scale-110 shadow-lg"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center h-11 w-11 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] transition-all hover:scale-110 shadow-lg"
