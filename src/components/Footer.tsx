        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <div className="relative group inline-block mb-4">
              <div className="absolute -inset-2 bg-gradient-to-r from-primary via-yellow-400 to-primary opacity-30 blur-md group-hover:opacity-50 transition-opacity" />
              <h3 className="relative font-bold text-4xl bg-gradient-to-r from-primary via-yellow-300 to-primary bg-clip-text text-transparent">
                ZESTMON
              </h3>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="group/icon relative flex items-center justify-center h-12 w-12 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all"
                  aria-label="YouTube Channel"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-[#FF0000] via-[#FF3333] to-[#CC0000] group-hover/icon:scale-110 transition-transform" />
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/30 to-white/0 group-hover/icon:translate-x-full transition-transform duration-700" />
                  <svg className="h-6 w-6 text-white relative z-10 group-hover/icon:scale-125 group-hover/icon:rotate-12 transition-all" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-[#5865F2] via-[#6875F5] to-[#4752C4] group-hover/icon:scale-110 transition-transform" />
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/30 to-white/0 group-hover/icon:translate-x-full transition-transform duration-700" />
                  <svg className="h-6 w-6 text-white relative z-10 group-hover/icon:scale-125 group-hover/icon:rotate-12 transition-all" fill="currentColor" viewBox="0 0 24 24">
