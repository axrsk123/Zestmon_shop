...
export const products: Product[] = [
  ...
  {
    id: "1b",
    name: "Classic Lemonade - Bottle",
    price: 8.99,
    image: classicImage,
    category: "Classic",
    description: "Our signature fresh-squeezed lemonade in a convenient take-home bottle.",
    rating: 5,
  },
  {
    id: "2",
  ...
  {
    id: "2b",
    name: "Strawberry Lemonade - Bottle",
    price: 9.99,
    image: strawberryImage,
    category: "Fruit Fusion",
    description: "Sweet strawberries blended with tangy lemons in a convenient take-home bottle.",
    rating: 5,
  },
  {
    id: "3",
  ...
  {
    id: "3b",
    name: "Mint Lemonade - Bottle",
    price: 9.49,
    image: mintImage,
    category: "Herbal",
    description: "Cool mint leaves infused with fresh lemonade in a convenient take-home bottle.",
    rating: 4,
  },
  {
    id: "4",
  ...
  {
    id: "4b",
    name: "Blueberry Lemonade - Bottle",
    price: 9.99,
    image: blueberryImage,
    category: "Fruit Fusion",
    description: "Antioxidant-rich blueberries meet zesty lemons in a convenient take-home bottle.",
    rating: 5,
  },
  {
    id: "5",
  ...
  {
    id: "5b",
    name: "Peach Lemonade - Bottle",
    price: 9.99,
    image: peachImage,
    category: "Fruit Fusion",
    description: "Juicy peaches combined with fresh lemons in a convenient take-home bottle.",
    rating: 5,
  },
  {
    id: "6",
  ...
  {
    id: "6b",
    name: "Raspberry Lemonade - Bottle",
    price: 9.99,
    image: raspberryImage,
    category: "Fruit Fusion",
    description: "Tart raspberries complement fresh lemons in a convenient take-home bottle.",
    rating: 4,
  },
  {
    id: "7",
  ...
  {
    id: "7b",
    name: "Lavender Lemonade - Bottle",
    price: 10.49,
    image: lavenderImage,
    category: "Herbal",
    description: "Delicate lavender flowers in a sophisticated take-home bottle.",
    rating: 5,
  },
  {
    id: "8",
  ...
  {
    id: "8b",
    name: "Watermelon Lemonade - Bottle",
    price: 9.99,
    image: watermelonImage,
    category: "Fruit Fusion",
    description: "Refreshing watermelon juice mixed with lemonade in a convenient take-home bottle.",
    rating: 5,
  },
  {
    id: "9",
  ...
  {
    id: "9b",
    name: "Mango Lemonade - Bottle",
    price: 9.99,
    image: mangoImage,
    category: "Tropical",
    description: "Tropical mango meets bright lemon in a convenient take-home bottle.",
    rating: 4,
  },
  {
    id: "10",
  ...
  {
    id: "10b",
    name: "Ginger Lemonade - Bottle",
    price: 9.49,
    image: gingerImage,
    category: "Spiced",
    description: "Fresh ginger root adds a zesty kick in a convenient take-home bottle.",
    rating: 4,
  },
];
